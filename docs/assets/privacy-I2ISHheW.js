...
`;(function(){const a="cabra_cookie_consent_v1",l=localStorage.getItem(a);if(l==="accepted"||l==="rejected")return;const e=document.createElement("div");e.className="cookie-wrap",e.innerHTML=`
  ...
  `,document.body.appendChild(e);const s=document.getElementById("cookie-accept"),t=document.getElementById("cookie-reject"),r=()=>{e.classList.add("cookie-hidden"),setTimeout(()=>e.remove(),200)};s==null||s.addEventListener("click",()=>{localStorage.setItem(a,"accepted"),r()}),t==null||t.addEventListener("click",()=>{localStorage.setItem(a,"rejected"),r()})})();
