    ...
    <header class="cabra-header sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-950/60">
      <nav class="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 md:px-0">
        ...
        <div class="hidden md:flex items-center gap-10 text-sm font-medium">
          ...
          <a href="/terms.html" class="rounded-full px-3 py-2 text-slate-200 hover:text-emerald-300 transition-colors active:bg-slate-800/40">Términos</a>
          <a href="/privacy.html" class="rounded-full px-3 py-2 text-emerald-200 border border-emerald-400/30 bg-emerald-500/10 transition-colors active:bg-slate-800/40">Privacidad</a>
        </div>
