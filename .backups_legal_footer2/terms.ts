...
app.innerHTML = `
  <div class="min-h-screen bg-slate-950 text-slate-50">
    <style>
      ...
      /* ✅ Cookie banner (igual que privacidad) */
    ...
    <header class="cabra-header sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-950/60">
      <nav class="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 md:px-0">
        ...
        <div class="hidden md:flex items-center gap-10 text-sm font-medium">
          <a href="/" class="rounded-full px-3 py-2 text-slate-200 hover:text-emerald-300 transition-colors active:bg-slate-800/40">Inicio</a>
          <a href="/faq.html" class="rounded-full px-3 py-2 text-slate-200 hover:text-emerald-300 transition-colors active:bg-slate-800/40">FAQ</a>
          <a href="/terms.html" class="rounded-full px-3 py-2 text-emerald-200 border border-emerald-400/30 bg-emerald-500/10 transition-colors active:bg-slate-800/40">Términos</a>
          <a href="/privacy.html" class="rounded-full px-3 py-2 text-slate-200 hover:text-emerald-300 transition-colors active:bg-slate-800/40">Privacidad</a>
        </div>
        ...
        <article class="legal-card rounded-3xl p-6 md:p-7 card-soft">
          ...
          <div class="mt-4 rounded-2xl border border-white/10 bg-white/5 p-4">
            <p class="text-sm text-slate-200/90">
              ...
              <span class="text-slate-400"> (ajústalo si usas otro correo)</span>
            </p>
          </div>
        </article>
      </section>

      <!-- FOOTER (MISMO 3 COLUMNAS DE HOME + links legales) -->
